...
CChinesePinyinTable::CChinesePinyinTable(QString DatabaseAlias,QString TableName)
{
...
void CChinesePinyinTable::setDatabaseAlias(QString DatabaseAlias)
{
     m_DatabaseAlias = DatabaseAlias;
}

void CChinesePinyinTable::setTableName(QString TableName)
{
    m_TableName = TableName;
}

bool CChinesePinyinTable::openDatabase()
{
